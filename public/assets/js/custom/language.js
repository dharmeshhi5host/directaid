$(function () {
    ...
    $(document).on('click', '.by-default-change', function () {
        const value_id = $(this).data('id');
        const status = $(this).data('status');
         const defstatus = $(this).data('defstatus');
        swal({
            title: status,
            text: status_msg,
            type: 'warning',
            ...
            if (isConfirm) {
                changeByDefaultStatus(value_id, defstatus)
            }
        });
    });
    ...
    function changeStatus(value_id, status) {
     ...
     function changeByDefaultStatus(value_id, status) {
        axios
            .get(APP_URL + '/language/changeByDefaultStatus' + '/' + value_id + '/' + status)
            .then(function (response) {
                table.draw()
                successToast(response.data.message, 'success');
            })
