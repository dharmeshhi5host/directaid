$(function () {
    ...
    $form.on('submit', function (e) {
        ...
        if ($form.parsley().isValid()) {
            ...
            axios
                .post(APP_URL + '/nationality', formData)
                .then(function (response) {
                    ...
                    setTimeout(function () {
                        window.location.href = APP_URL + '/nationality'
                    }, 1000);
    ...
    function deleteRecord(value_id) {
        ...
        $.ajax({
            type: 'DELETE',
            url: APP_URL + '/nationality' + '/' + value_id,
    ...
    function changeStatus(value_id, status) {
        axios
            .get(APP_URL + '/nationality/status' + '/' + value_id + '/' + status)
            .then(function (response) {
                table.draw()
                successToast(response.data.message, 'success');
            })
