...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.edit_nationality') }}</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        @csrf
                        <input type="hidden" id="edit_value" name="edit_value" value="{{ $nationality->id }}">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{ $nationality->translateOrNew($language->language_code)->name }}"
...
@endsection
@section('js')
    <script src="{{URL::asset('assets/js/custom/nationality.js')}}?v={{ time() }}"></script>
@endsection
