...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.languages') }}</h2>

            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('admin.language.create') }}" class="btn btn-primary  mr-2">
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap" id="data-table">
                            ...
                            <tr>
                                ...
                                <th>{{ config('languageString.is_rtl') }}</th>
                                <th>{{ config('languageString.language_code') }}</th>
                                <th>{{ config('languageString.status') }}</th>
                                <th>{{ config('languageString.by_default') }}</th>
...
@section('js')
    <script>
        const sweetalert_title = "{{ config('languageString.destroy_language').'?' }}";
    ...
    <script src="{{URL::asset('assets/js/custom/language.js')}}"></script>
@endsection
