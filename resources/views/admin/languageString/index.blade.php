        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                @if(Auth::user()->id !=3)
                    ...
                    <a href="{{ route('admin.language-string.update-developer-mode') }}" class="btn btn-primary  mr-2">
                        {{ config('languageString.'.((int)$devMode->meta_value === 1 ? 'turn_off_dev_mode':'turn_on_dev_mode')) }}
                    </a>
                @endif
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 input-group">
                            <select id="panel"
                                ...
                                <option value="1" selected>{{ config('languageString.app') }}</option>
                                <option value="2">{{ config('languageString.front_panel') }}</option>
                            </select>
