...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.edit_language_string') }}</h2>
                ...
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        ...
                        @if(Auth::user()->id !=3)
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="app_or_panel" name="app_or_panel">
                                        ...
                                        <option value="2" @if($languageString->language_screen->app_or_panel==2) selected @endif>{{ config('languageString.front_panel') }}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="language_screen_name">{{ config('languageString.language_screen') }}<span
                                            class="error">*</span></label>
