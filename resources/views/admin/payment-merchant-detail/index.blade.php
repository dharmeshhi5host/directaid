...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.payment_merchant_detail') }}</h2>

            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('admin.payment-merchant-detail.create') }}" class="btn btn-primary  mr-2">
...
{{--                                <th>{{ config('languageString.center_id') }}</th>--}}
                                <th>{{ config('languageString.title') }}</th>
                                <th>{{ config('languageString.merchant_id') }}</th>
...
@section('js')
    <script>
        const sweetalert_title = "{{ config('languageString.payment_merchant_detail').'?' }}";
